window.addEventListener('load', () => {
  ...
  const results = [
    ...
    },
    {
      title: 'Сотрудничество',
	    text: {
		    0:'Как часто можно слышать о специалисте: «Профессионал хороший, но работать с ним — ни за что!» Сегодня, когда почти все начинания требуют работы в коллективе, когда самая блестящая идея не может быть реализована без вклада множества специалистов, умение сотрудничать — один из самых насущных навыков.',
		    1:'Командная работа — одна из сильных сторон «Летово»: ученики учатся сотрудничеству, работая в школьном самоуправлении, создавая социальные и благотворительные проекты.'
	    },
      image: {
    ...
    },
    {
      title: 'Самоорганизация',
	    text: {
		    0:'Именно тот метапредметный навык, который «проседает» даже у взрослых людей — и спросите, рады ли они этому? Самоорганизация — залог не только успешной работы, но и гармоничной жизни.',
		    1:'Школьники в «Летово» учатся самоорганизации непрерывно, составляя индивидуальный учебный план, отслеживая поставленные перед собой цели, стараясь успеть на все виды активностей, предлагаемые школой, от исторического фехтования до робототехники. Да и жизнь в школе без звонков (а в «Летово» их нет не случайно) способствует развитию организованности.'
	    },
      image: {
    ...
    },
    {
      title: 'Исследование',
	    text: {
		    0:'Стремление «дойти до самой сути» явления ценится во всех профессиональных сферах. Умение поставить исследовательский вопрос, составить план работы и представить результат в «Летово» оттачивается за дискуссионным столом и в химических лабораториях, на выступлениях в формате TED и даже... в спортивных залах.',
		    1:'Это не шутка, ведь исследовательский подход важен и в спорте, и в творчестве, и в научной деятельности — а ученики «Летово» должны попробовать себя во всем перечисленном.'
	    },
      image: {
        name: 'study.svg',
        width: '468',
    ...
    },
    {
      title: 'Критическое мышление',
	    text: {
		    0:'Ежечасно на нас обрушивается поток информации, и его плотность продолжает нарастать. Так же будет нарастать «спрос» на умение работать с этой информацией: отделять достоверное, анализировать, использовать в своей деятельности.',
		    1:'В «Летово» критическое мышление особенно востребовано в ходе работы над проектами: ученики школы создают востребованные на рынке устройства для исправления осанки, запускают масштабные образовательные проекты, разрабатывают мобильные приложения — и, конечно же, успешно и увлеченно учатся.'
	    },
      image: {
  ...
  const setResult = () => {
    ...
    resultTitle.textContent = resultItem.title;
	  ...
	  Object.keys(resultItem.text).forEach(key => {
		  text += '<p>'+resultItem.text[key]+'</p>';
	  });
